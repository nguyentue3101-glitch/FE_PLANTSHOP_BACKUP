...
export const updateOrderDetail = async (orderDetailId, token, orderDetailData) => {
    const response = await apiClient.put(`/api/order-details/${orderDetailId}`, orderDetailData, {
        headers: {
...
export const updateOrderShippingStatus = async (orderId, token, shippingStatus) => {
    const response = await apiClient.put(`/api/orders/${orderId}/shipping-status`, { shipping_status: shippingStatus }, {
        headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json"
        },
...
export const updateOrderShippingInfo = async (orderId, token, shippingInfo) => {
    const response = await apiClient.put(`/api/orders/${orderId}/shipping-info`, shippingInfo, {
        headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json"
        },
